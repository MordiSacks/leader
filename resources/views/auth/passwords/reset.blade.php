...
@section('content')
    <form method="post">
        ...
        <div class="in">
            ...
            <input type="email" name="email" dir="ltr" value="{{ $email }}"
        ...
        <div class="in">
            ...
            <input type="password" name="password_confirmation"
                   aria-label="@lang('Confirm password')" placeholder="@lang('Confirm password')"
...
@push('body-end')
    <script>
        document.addEventListener('msg:closed', function () {
